                                        ...
                                        Container(
                                          ...
                                          child: Padding(
                                            padding: const EdgeInsets.only(
                                                right: 20.0),
                                            child: Image.network(
                                              items[selectedIndex].brand!.logo.toString(),
                                          ...
                                          child: Column(
                                            children: [
                                              Container(
                                                ...
                                                width: 200,
                                                child: Text(
                                                  items[selectedIndex].title.toString(),
                                                  style: TextStyle(
                                                      color: Colors.black
                                                          .withOpacity(0.73),
                                                      fontWeight:
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  width: 100,
                                                  child: Text(
                                                    items[selectedIndex].ctaLong.toString(),
                                                    style: TextStyle(
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                    ...
                                                    child: RatingBar.builder(
                                                      initialRating: items[selectedIndex]
                                                          .customdata!
                                                          .apprating ??
                                                          0.0,
                                                      minRating: 1,
                                      ...
                                      child: Row(children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            width: 260,
                                            child: Text(
                                              detail[selectedIndex].description.toString(),
                                              style: TextStyle(
                                                  color: Colors.black
                                                      .withOpacity(0.73),
                                                  fontWeight: FontWeight.bold,
                                        ...
                                        Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: Center(
                                                  child: Text(
                                                    detail[selectedIndex].payout.toString(),
                                                    style: TextStyle(
                                                        color: Colors.black
                                                            .withOpacity(0.73),
                                                        fontWeight: FontWeight.bold,
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              width: 300,
                                              child: Text(
                                                items[selectedIndex].shortDesc.toString(),
                                                style: TextStyle(
                                                    color: Colors.black
                                                        .withOpacity(0.5),
                                                    fontWeight: FontWeight.bold,
                                      ...
                                      child: Row(children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            width: 240,
                                            child: Text(
                                              "Refer ${items[selectedIndex].brand!.title} to friend",
                                              style: TextStyle(
                                                  color: Colors.black
                                                      .withOpacity(0.73),
                                                  fontWeight: FontWeight.bold,
